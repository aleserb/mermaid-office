...
directly by control ID in a fresh Word request before sizing. Its identity and
saved source are rechecked before committing the update. Initial insertion still uses OOXML.
